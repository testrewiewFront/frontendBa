...
const PaymentComponent = () => {
    ...
    const fetchWalletAddresses = async () => {
        try {
            ...
            const cryptoResponse = await axios.get('http://localhost:5000/api/cryptodetails/public');
            ...
            const transformedData: WalletAddress[] = cryptoResponse.data.map((crypto: any) => ({
                ...
                image: crypto.image ? `http://localhost:5000${crypto.image}` : iconMap[crypto.label] || Balance
            }));
